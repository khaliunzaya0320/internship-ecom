      ...
      {filteredOrders.length > 0 ? (
        <div className="space-y-4">
          {filteredOrders.map((order) => (
            <div key={order.id} className="bg-white rounded-lg shadow border p-6">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="font-semibold">Захиалга #{order.id}</h3>
              ...
              {/* Order Items Preview */}              <div className="border-t pt-4">
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">
            {statusFilter === "ALL" ? "Захиалга байхгүй байна" : `${getStatusText(statusFilter)} захиалга байхгүй байна`}
          </h3>
