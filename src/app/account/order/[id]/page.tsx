...
const OrderDetailPage = () => {
  ...
  if (!order) {
    return (
      <div className="m-6">
        <div className="text-center text-gray-500">Захиалга олдсонгүй</div>
      </div>
    );
  }
    ...
    <div className="m-6 max-w-4xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div>
                <p className="text-sm text-gray-600">Захиалгын дугаар</p>
            ...
            {/* Order Items */}
            <h3 className="text-lg font-semibold mb-4">Захиалсан бараа</h3>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-semibold mb-4">Төлбөрийн мэдээлэл</h3>
            ...
            <div className="border-t pt-4">
              <div className="flex justify-between font-semibold text-lg">
                <span>Нийт дүн</span>
                <span className="text-rose-600">{order.total.toLocaleString()}₮</span>
              </div>
            </div>
          </div>
          ...
          {order.user && (
            <div className="bg-white rounded-lg shadow p-6">
              <h3 className="text-lg font-semibold mb-4">Захиалагчийн мэдээлэл</h3>
              <div className="space-y-2">
                ...
                <div>
                  <p className="text-sm text-gray-600">Имэйл</p>
