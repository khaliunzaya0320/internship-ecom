...
const LoginPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError("Нэвтрэхэд алдаа гарлаа");    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4"><div className="relative">
      ...
      </form>      <div className="flex justify-center mt-6 gap-2 text-sm">
