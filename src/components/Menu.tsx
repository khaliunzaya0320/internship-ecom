...
const Menu = () => {
  ...
  const menuItems = [
    { href: "/order", label: "Захиалга хайх", icon: <Package className="menu-icon" /> },
    ...
    <nav className="flex gap-6 text-sm font-medium items-center relative" ref={dropdownRef}>
      ...
      {session ? (
        <div className="relative">          <button
            ...
            className={`navbar-menu flex flex-col items-center ${
              accountOpen || pathname.startsWith("/account") ? "text-rose-500 font-semibold" : "text-gray-600 hover:text-rose-400"
            }`}
          >
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2V7zm8 6l4-4m0 0l-4-4m4 4H7" />
                      </svg>
                      Хяналтын самбар
                    </div>
                  </Link>
