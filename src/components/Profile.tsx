...
import { User, Lock, MapPin, Plus, Edit, Trash2, Phone, Mail } from "lucide-react";
        ...
        {activeTab === 1 && (
          <div>
            ...
            <form onSubmit={handlePasswordChange} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Хуучин нууц үг</label>
                <input 
                  type="password" 
                  className="form-input" 
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Шинэ нууц үг баталгаажуулах</label>
                <input 
                  type="password" 
                  className="form-input" 
        ...
        {activeTab === 2 && (
          <div>
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-semibold">Хүргэлтийн хаягууд</h3>
              <button
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 text-sm">
                        {address.address}, {address.district && `${address.district}, `}{address.city}
                      </p>
                    </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleAddressSubmit} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Хаягийн нэр</label>
                <input
                  type="text"
                  className="form-input"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Хот/Аймаг</label>
                <input
                  type="text"
                  className="form-input"
